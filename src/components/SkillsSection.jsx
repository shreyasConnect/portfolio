...
const skills = [
  ...
  { name: "MySQL", level: 85, category: "data" },
  { name: "Query Optimization", level: 80, category: "data" },
  { name: "Data Validation", level: 85, category: "data" },

  // Testing & QA
  { name: "API Testing", level: 85, category: "testing" },
  { name: "Jest", level: 80, category: "testing" },
  { name: "Debugging", level: 85, category: "testing" },
  { name: "System Testing", level: 80, category: "testing" },
...
const categories = ["all", "languages", "web", "data", "testing", "tools"];
